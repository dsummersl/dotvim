require("lazy").setup({
  ...
  { "dense-analysis/neural",
...

	{
		...
		config = function() -- show git blame in the editor.
	...
	},
	{
      ...
      require("telescope").load_extension("live_grep_args")
        ...
        noremap <leader>gs :Telescope grep_string<cr>
      ]])
		end,
	},
	{
	...
	{ dir = "~/Documents/classes/nvim-sluice", config = function() end },
	{
		"SirVer/ultisnips",
		config = function()
			vim.cmd([[
